...
public class AuthenticationController {
    ...
    private static void setUserInSession(HttpSession session, Optional<User> user) {
        session.setAttribute(userSessionKey, user.get().getUsername());
    }
    ...
    public String processLoginForm(@ModelAttribute @Valid RegisterFormDTO RegisterFormDTO,
        ...
        Optional<User> theUser = userRepository.findById(RegisterFormDTO.getUsername());
    ...
    public String processLoginForm(@ModelAttribute @Valid LoginFormDTO loginFormDTO,
        ...
        Optional<User> theUser = userRepository.findById(loginFormDTO.getUsername());
